...
var id = "nli_beta_speedup";

var getName = (language) => {
    const names =
    {
        en: 'Nonlinear Integration (speedup)',
    };
...
var getDescription = (language) => {
    const descs =
    {
        en: "x3600 speedup\nA custom theory about the Riemann-Stieltjes integral\n" +
    "Now in development",
    };
...
const rhoParallelCost = BigNumber.from('1e940');
...
const q1Cost = new FirstFreeCost(new ExponentialCost(5000, Math.log2(31.2)));
const q1aCost = new FirstFreeCost(new ExponentialCost(5000, Math.log2(31.2)));
