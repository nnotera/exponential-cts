...
var id = "generating_functions_spedup"
var name = "Generating Functions (su)";
...
var tick = (elapsedTime, multiplier) => {
    ...
    q += dt * BigNumber.TWO.pow(multQDot.level) * ssval.pow(1+(theory.achievements[2].isUnlocked)*0.05) * ttval.pow(1+(theory.achievements[3].isUnlocked)*0.05)  * zzval.pow(1+(theory.achievements[4].isUnlocked)*0.1) * (theory.achievements[0].isUnlocked?1.15:1.00);
    t += dt/multiplier;
