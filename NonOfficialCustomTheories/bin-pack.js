...
var id = "bin_packing_speedup";
var name = "Bin Packing (speedup)";
var description = "x3600 speed\nPack as many Items as you can into Bins, each Bin has a set size.\n"+
...
var tick = (elapsedTime, multiplier) => {
    let dt = BigNumber.from(elapsedTime*multiplier*3600); // x3600 
